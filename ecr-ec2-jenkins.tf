...
locals {
  github-email    = "omerfarukdemirozu@gmail.com"                 # you need to change this line
  github-username = "MiranaSGit"                                  # you need to change this line
  github-token    = "ghp_XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"          # you need to change this line
  key_pair        = "ofd"                                         # you need to change this line
  pem_key_address = "~/OneDrive/Documents/Cohort-008/AWS/ofd.pem" # you need to change this line
}
